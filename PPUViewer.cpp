...
PPUViewer::PPUViewer()
{
  ...
  m_RotateButtonx = new QPushButton("Rotate x");
  m_RotateButtonx->setObjectName(QStringLiteral("RotateButtonx"));
  mainLayout->addWidget(m_RotateButtonx);
  connect(m_RotateButtonx, SIGNAL(pressed()), m_RenderWidget, SLOT(rotateAboutx()));
